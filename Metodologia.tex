...
\end{itemize} 
	...
	Estes dados serão inicializados com valores neutros dessa maneira evitando qualquer comportamento tendencioso. Os dados  serão atualizados conforme o desempenho e estado das heurísticas de baixo nível durante o progresso da busca.   
...
Um conjunto de experimentos serão executados utilizando várias sequências de aminoácidos utilizadas para avaliar estratégias heurísticas para o PDP utilizando o modelo HP. Estas sequências foram  utilizadas em outros trabalhos \cite{custodio2004investigation,hsu2003growth,lin2011protein,unger1993genetic,santanna2008,custodio2014multiple, garza2012locality} que também exploram o PDP utilizando o modelo HP. A \autoref{tab:sequences} apresenta o id de cada sequência, o seu tamanho (quantidade de aminoácidos), o valor ótimo conhecido da respectiva sequência e a ultima coluna apresenta a sequência propriamente dita. 
