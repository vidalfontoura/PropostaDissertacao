...
\frame{
	...
	\begin{block}{Hiper Heurísticas de Seleção}
		\begin{itemize}
...
\frame{
	...
	\begin{block}{Hiper-heurísticas de Geração}
...
\frame{
	...
	\begin{block}{Programação Genética (PG)}
...
\frame{
	...
	\begin{block}{Evolução Gramatical (EG)}
...
\frame{
	...
	\begin{block}{Operadores para evolução gramatical}
...
\frame{
	...
	\begin{block}{Pseudocódigo da evolução gramatical}
