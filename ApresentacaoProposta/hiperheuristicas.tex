...
\frame{
	\frametitle{Exemplo de decodificação de cromossomo}
		...
		Vetor exemplo: 10 27 10 14 12 23 16 20
		
		\begin{itemize}
					\item 10 mod 4 = 0  $\to  \langle expr \rangle$  $\langle op \rangle$  $\langle expr \rangle$ 
					...
					\item 14  mod 4 = 1  $ \to  X + (\langle pre-op\rangle  \langle expr\rangle)$  
