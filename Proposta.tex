\documentclass[12pt,a4paper]{ufpr2}
...
%=========== Co-Orientador ===========
% se usar o ufpr2.cls, presente no início do documento, utilizar as definições abaixo, caso contrário deve comentá-las
\coadvisortitle{Co-orientador} % ou Orientador
\coadvisorname{Prof. Dr. Roberto Santana Hermida}
	\coadvisorplace{Departamento de Informática, UFPR}  % departamento, instituicao
	%=========== Co-Orientador ===========
