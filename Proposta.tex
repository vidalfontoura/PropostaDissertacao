...
\title{Uma proposta de design automático de heurísticas alto nível para um \textit{framework} hiper-heurístico aplicado ao problema de dobramento de proteínas utilizando o modelo hp 3d}
