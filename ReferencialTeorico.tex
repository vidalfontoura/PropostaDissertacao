...
O Algoritmo \ref{alg:GE} apresenta o pseudocódigo da evolução gramatical (EG). Note que o pseudocódigo é muito similar a um algoritmo genético simples. Na linha 3 e 4 apresenta a inicialização da população e o mapeamento para programas utilizando a gramática que foi provida como entrada. Em seguida, na linha 5 ocorre a execução dos programas e na linha 6 a acontece a avaliação dos indivíduos da população baseando-se na saída obtida pelos respectivos programas. Dentro do laço principal apresentado na linha 7 podemos observar o processo de seleção dos indivíduos pais na linha 8, na linha 9 o processo de cruzamento destes indivíduos.
