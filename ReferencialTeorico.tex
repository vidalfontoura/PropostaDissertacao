...
\begin{algorithm}[htb]
	...
	\Begin{
		...
		\While{Condição de parada não atingida}{
			$matingPopulation \gets $ Select parents\;
			$offspring \gets$ Recombine $matingPopulation$\;
			Apply gene prune operator to the solutions of $offspring$\;
			Apply gene duplication operator to the solutions of $offspring$\;
